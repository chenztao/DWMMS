...
public class Dispatcher {
    ...
    public static void main(String[] args) {
        ApplicationContext app = new ClassPathXmlApplicationContext("resources/spring-applicationContext.xml");
    ...
    private String hmiControler(String recieveStr, SocketChannel client) {
        ...
        switch (dataType) {
            case "close":
                break;
            case "register":
                response = driverInfoHandler.register(recieveStr);
                break;
            case "login":
                response = driverInfoHandler.login(recieveStr);
                break;
            case "saveWarningMsg":
                response = warningInfoHandler.setWarning(recieveStr);
                break;
            case "getAllWarningInfo":
                response = warningInfoHandler.getWarning(recieveStr);
                break;
            default:
